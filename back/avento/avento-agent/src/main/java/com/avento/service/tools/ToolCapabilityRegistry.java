...
public class ToolCapabilityRegistry {
    ...
    public ToolCapabilityRegistry() {
        ...
        register(
                ...
                ToolApprovalPolicy.AUTO,
                false,
                "Pesquisa no catalogo leve de capacidades de ferramentas por palavra-chave.");
        register(
                definitions,
                "activate_tools",
                ToolCategory.MEMORY,
                ...
                ToolApprovalPolicy.AUTO,
                false,
                "Ativa os schemas completos das ferramentas solicitadas para a execucao atual.");
        register(
                definitions,
                "remember",
                ToolCategory.MEMORY,
        ...
        register(
                ...
                ToolApprovalPolicy.AUTO,
                true,
                "Cria uma skill reutilizavel (procedimento com gatilhos) a pedido do usuario.");
        register(
                definitions,
                "list_skills",
                ToolCategory.MEMORY,
                ...
                ToolApprovalPolicy.AUTO,
                true,
                "Lista as skills embutidas e criadas pelo usuario.");
        register(
                definitions,
                "delete_skill",
                ToolCategory.MEMORY,
                ...
                ToolApprovalPolicy.AUTO,
                true,
                "Apaga uma skill criada pelo usuario pelo nome.");
        register(
                definitions,
                "read_document",
                ToolCategory.FILESYSTEM,
